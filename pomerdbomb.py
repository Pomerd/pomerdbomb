...
r = get("https://raw.githubusercontent.com/Pomerd/smsbomb/main/sms.py").text
...
------------------------
Güncel toollardan haberdar olmak için discord ve telegram kanalımızı takip et
------------------------
discord.gg/axid
t.me/p0merdaga
------------------------
    ...
    print(Fore.LIGHTGREEN_EX+"{/} "+Style.RESET_ALL+"Katkıda bulunanlar: "+Fore.LIGHTGREEN_EX+Style.BRIGHT+"edited by POMERD\n"+Style.RESET_ALL)
    try:
